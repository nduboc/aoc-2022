...
if __name__ == "__main__":
    ...
    boundDown += 2 # add space at the base
    boundLeft = 500 - boundDown - 10
    boundRight = 500 + boundDown + 10
    paths.append(((boundLeft, boundDown), (boundRight, boundDown)))
    ...
    while True:
        ...
        if dest == start:
            wall.draw()
            print(f"Full after step {i}, confirmed 26375")
            break
        i+=1
